...
6. Submitting all the solutions automatically
7. Store the submitted solution locally in a specific format("104 - Arbitrage.cpp") and verify if it got AC
8. Preparing status report
9. Checking if the problem is already solved on judge